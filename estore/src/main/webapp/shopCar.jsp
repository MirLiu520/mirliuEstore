...
<body>
	...
	<div class="top" id="top">
		<div class="herf">
			<span><a href="index.html">首页</a></span> <span><a>登录</a></span> <span><a>注册</a></span>
	...
	<div class="body">
			...
			<c:forEach items="${sessionScope.shopCar.items }" var="item">
				<div class="row">
					...
					<div class="col-md-2 column">
						<fmt:formatNumber  maxIntegerDigits="3"
					...
					<div class="col-md-2 column">
					<fmt:formatNumber  maxIntegerDigits="3"
							value="${item.book.price * item.num }" 
							type="currency" ></fmt:formatNumber>
		...
		<div class="allButtom">
			...
			<span>已选择<font id="book-num" style="color: #b11e22;">
							${sessionScope.shopCar.countNum }</font>件商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			总价(不含运费)：
			<font id="price-num" style="color: #b11e22;">
			<fmt:formatNumber  maxIntegerDigits="4"
					value="${sessionScope.shopCar.total }" 
					type="currency" ></fmt:formatNumber> </font>元
			</span>
		</div>
	</div>
