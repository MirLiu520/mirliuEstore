		...
		<div class="body">
			<div class=" receiver">
				...
				<div class="row">
					<form class="form-horizontal col-md-7 column" role="form">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" disabled="disabled"  value="张三" />
							</div>
						</div>
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label">收货地址：</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" disabled="disabled"  value="江苏省苏州市昆山市巴城镇学院路浦东软件园" />
							</div>
						</div>
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label">收货人电话：</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" disabled="disabled"  value="18890998777" />
							</div>
						</div>
					</form>
				</div>
				<div class="row sendlist">
					送货清单
					<a href="shopCar.html" style="display: inline-block;float: right;margin-right: 50px;  font-size: 14px;color:blue !important;">返回修改购物车</a> 
				</div>
				<div class="bigDiv">
					...
					<div class="twoDiv row">
						...
						<div class="col-md-3 column pic">
							<img src="images/book_shopCart/book1.jpg" >
						</div>
			...
			<div class="allButtom">
				<p class="caozuo">
					<a href="order/addOrder.do">订单确认</a>
				</p>
				<span>共<font id="book-num" style="color: #b11e22;">
				${sessionScope.shopCar.countNum }
				</font>件商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				应付：¥
				<font id="price-num" style="color: #b11e22;">
					<fmt:formatNumber  maxIntegerDigits="4"
					value="${sessionScope.shopCar.total }" 
